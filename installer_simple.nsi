; Instagram Auto Poster - Simple Professional Windows Installer
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\gui_installer.py"
...
Section "Core Application" SecCore
    ...
    ; Copy all application files from the package directory
    File /r "Instagram_Auto_Poster_Package\*.*"
    
    ; Create desktop shortcut to the main launcher
    CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\gui_installer.py"
    
    ; Create Start Menu shortcuts
    CreateDirectory "$SMPROGRAMS\${APP_NAME}"
    CreateShortCut "$SMPROGRAMS\${APP_NAME}\${APP_NAME}.lnk" "$INSTDIR\gui_installer.py"
...
Section "Desktop Integration" SecDesktop
    ...
    CreateShortCut "$DESKTOP\Instagram Auto Poster - Setup.lnk" "$INSTDIR\gui_installer.py"
...
Section "Auto-Startup" SecAutoStart
    ...
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "InstagramAutoPoster" "$INSTDIR\gui_installer.py"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    ...
    !insertmacro MUI_DESCRIPTION_TEXT ${SecDesktop} "Create desktop shortcuts"
