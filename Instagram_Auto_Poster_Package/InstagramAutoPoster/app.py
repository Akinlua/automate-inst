    ...
    try:
        ...
        def update_env_file_with_profile(profile_path):
            ...
            try:
                ...
                print(f"[OK] Updated .env file with Chrome profile: {profile_path}")
                return True
                
            except Exception as e:
                print(f"[ERROR] Error updating .env file: {str(e)}")
                return False
...
if __name__ == "__main__":
    ...
    print("[MOBILE] Visit http://localhost:5003 to manage your content")
